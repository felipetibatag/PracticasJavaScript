...
//filtrando datos
//console.log(SCRIPTS.filter(data=>data.direction=="ttb"));
//usando map
let datosParaMapearPorLivingTrue=SCRIPTS.filter(data=>data.living=true);
console.log(datosParaMapearPorLivingTrue.map(data=>data.name));
